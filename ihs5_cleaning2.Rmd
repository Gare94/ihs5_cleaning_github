...
ihs5[ihs5$cons_unit_oth == "PAIL (UNSPECIFIED)", "cons_unitA"] <- "51"
...
ihs5[ihs5$cons_unit_oth == "PAIL (UNSPECIFIED)", "cons_unit"] <- "51"
...
>MERGE IN CONVERSION FACTORS AND HOUSEHOLD CHARACTERICTICS 
...
ihs5 <- ihs5 %>% select(id:consYN, item_code, item_name_original, item_name_factor, item_oth:cons_unitA, cons_unit, unit_name, Otherunit, cons_unit_oth:gift_unit_size, factor, region,reside, district,hh_wgt,hhsize)
...
write.csv(consed, "C:/Users/Gareth Osman/OneDrive - LUANAR/Documents/MAPS Project/ihs5 Cleaning/ihs5_mod_g_clean.csv")
