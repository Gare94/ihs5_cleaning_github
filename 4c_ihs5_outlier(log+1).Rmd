...
ihs5 <- read.csv(here::here('hh_mod_g_kg.csv'))
ihs5 <- select(ihs5, -X)
...
ihs5 %>% filter(item_code==113) %$% summaplot(kg_ame_d)
...
outliers$kg_d_replace <-outliers$median * outliers$ame
 ...
 write.csv(outliers, here::here('ihs5.outliers.5sd2.csv'))
...
write.csv(ihs5, here::here('hh_mod_g_nep.csv'))
